...
% % s is the Type-2 Euclidean pseudo-similarity of the fpfs-matrices a and b 
% a=rand(5,4); 
% b=rand(5,4); 
% s=fpfss4(a,b);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Type-2 Euclidean pseudo-similarity over fpfs-matrices
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function X=fpfss4(a,b)
if size(a)~=size(b)
